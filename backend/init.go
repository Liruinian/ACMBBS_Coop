...
func main() {
	...
	r.GET("/", func(c *gin.Context) {
		c.JSON(200, gin.H{"code": 200, "msg": "Welcome to bbs.liruinian.top/api/ !", "version": 0.1, "description": "check documentation"})
	})
	r.NoRoute(func(c *gin.Context) {
		c.JSON(200, gin.H{"code": 404, "msg": "无“" + c.Request.RequestURI + "”接口，请查阅api文档后再次尝试访问"})
	})
	err := r.Run(Conf.Port)
	if err != nil {
